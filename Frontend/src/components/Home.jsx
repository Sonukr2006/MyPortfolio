  ...
  <div>
    ...
    <div className="container-custom px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <ProjectCard title="XSEAT" description="XSEAT helps passengers manage tickets" tech="React,Node, WebSocket" image="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=60" link="https://xseat.vercel.app/"/>
        <ProjectCard title="FocusTube" description="A focused webapp for Student" tech="React, Node, Express" image="https://r.testifier.nl/Acbs8526SDKI/resizing_type:fit/width:1080/height:720/plain/https://s3-newsifier.ams3.digitaloceanspaces.com/gizchina.com/images/2025-06/imagem-2021-12-19-131842.png@webp" link="https://focus-tube-ecru.vercel.app/" />
